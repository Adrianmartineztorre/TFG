"""
Entrenamiento específico del modelo cnn_bn_dropout.
Carga los splits desde data.py y construye los datasets TensorFlow desde preprocess.py.
Construye el modelo cnn_bn_dropout, ejecuta el entrenamiento y guarda el mejor checkpoint.
...
from d_Modelos.cnn_bn_dropout import (
    construir_modelo_cnn_bn_dropout as construir_modelo,
)
...
def main():
    parser = argparse.ArgumentParser(
        description="Entrenamiento cnn_bn_dropout"
    )
    ...
    # Modelo
    # ===============================
    print("\n🧠 Construyendo modelo cnn_bn_dropout...")
    ...
    # Carpetas
    # ===============================
    modelo_dir = MODELOS_DIR / "cnn_bn_dropout"
    modelo_dir.mkdir(parents=True, exist_ok=True)

    runs_dir = MODELOS_DIR.parent / "RUNS" / "cnn_bn_dropout"
    ...
    best_run["model_name"] = "cnn_bn_dropout"
