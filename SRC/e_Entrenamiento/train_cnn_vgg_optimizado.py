"""
Entrenamiento específico del modelo cnn_vgg_optimizado.
Carga los splits desde data.py, construye los datasets TensorFlow desde preprocess.py,
entrena cnn_vgg_optimizado y guarda el mejor checkpoint, history y best_run.
...
from d_Modelos.cnn_vgg_optimizado import construir_modelo_cnn_vgg_optimizado as construir_modelo
...
# Guardado común
# ===============================
def _guardar_resultados(history_dict: dict, runs_dir, model_path, nombre_modelo="cnn_vgg_optimizado"):
...
# ===============================
def main():
    parser = argparse.ArgumentParser(description="Entrenamiento cnn_vgg_optimizado")
    ...
    # Modelo
    # ===============================
    print("\n🧠 Construyendo modelo cnn_vgg_optimizado...")
    ...
    # Carpetas
    # ===============================
    modelo_dir = MODELOS_DIR / "cnn_vgg_optimizado"
    modelo_dir.mkdir(parents=True, exist_ok=True)

    runs_dir = MODELOS_DIR.parent / "RUNS" / "cnn_vgg_optimizado"
    ...
    try:
        ...
        history_path, best_run_path, best_run = _guardar_resultados(
            ...
            nombre_modelo="cnn_vgg_optimizado",
        )
