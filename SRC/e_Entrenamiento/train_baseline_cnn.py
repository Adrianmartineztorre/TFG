"""
Entrenamiento específico del modelo baseline_cnn.
Carga los datasets de entrenamiento y validación desde el pipeline de datos.
Construye el modelo baseline, ejecuta el entrenamiento y guarda el mejor checkpoint.
...
def main():
    parser = argparse.ArgumentParser(
        description="Entrenamiento baseline_cnn"
    )
    ...
    # Modelo
    # ===============================
    print("\n🧠 Construyendo modelo baseline_cnn...")
