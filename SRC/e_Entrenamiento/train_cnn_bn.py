"""
Entrenamiento específico del modelo cnn_bn.
Carga los splits desde data.py, construye los datasets TensorFlow desde preprocess.py,
entrena cnn_bn y guarda el mejor checkpoint, history y best_run.
"""
...
from d_Modelos.cnn_bn import construir_modelo_cnn_bn as construir_modelo
...
# ===============================
def main():
    parser = argparse.ArgumentParser(description="Entrenamiento cnn_bn")
    ...
    # Carpetas
    # ===============================
    modelo_dir = MODELOS_DIR / "cnn_bn"
    modelo_dir.mkdir(parents=True, exist_ok=True)

    runs_dir = MODELOS_DIR.parent / "RUNS" / "cnn_bn"
