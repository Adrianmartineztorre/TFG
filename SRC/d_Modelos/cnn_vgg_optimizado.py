...
def construir_modelo_cnn_vgg_optimizado() -> tf.keras.Model:
...
if __name__ == "__main__":
    print("=== DEBUG MODELO CNN_VGG_OPTIMIZADO ===")
    modelo = construir_modelo_cnn_vgg_optimizado()
    modelo.summary()
